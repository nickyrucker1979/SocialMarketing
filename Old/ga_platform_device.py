...
exaconnect.execute('delete from UNIVERSITY_WAREHOUSE_DEV.GA_PLATFORM_DEVICE')
...
results = service.data().ga().get(
    ...
    end_date='today',
    dimensions='ga:operatingSystem, ga:deviceCategory, ga:mobileDeviceBranding',
...
while start_index < totalResults:
     ...
     for row in getValue(results, ['rows']):
        ...
        exaconnect.writePandas(exa_write, 'UNIVERSITY_WAREHOUSE_DEV.GA_PLATFORM_DEVICE')
